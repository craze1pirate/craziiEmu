...
public static class KernelEventQueueCompatExports
{
    ...
    private static readonly bool _logEqueue =
        string.Equals(Environment.GetEnvironmentVariable("CRAZIIEMU_LOG_EQUEUE"), "1", StringComparison.Ordinal);
    ...
    public static int KernelAddHRTimerEvent(CpuContext ctx)
    {
        ...
        var tvSec = System.Buffers.Binary.BinaryPrimitives.ReadInt64LittleEndian(tsBytes[0x00..]);
        var tvNsec = System.Buffers.Binary.BinaryPrimitives.ReadInt64LittleEndian(tsBytes[0x08..]);
