...
internal sealed class MediaFramePlayback : IDisposable
{
    ...
    internal MediaFramePlayback(IMediaFrameDecoder decoder)
    {
        ...
        {
            IsBackground = true,
            Name = "CraziiEmu Bink video decoder",
        };
    ...
    /// the two together; CRAZIIEMU_MOVIE_CLOCK=wall restores the old behaviour.
    /// </summary>
    private static readonly bool _followGuestAudioClock = !string.Equals(
        Environment.GetEnvironmentVariable("CRAZIIEMU_MOVIE_CLOCK"),
        "wall",
    ...
    private static readonly bool _traceClockSkew = string.Equals(
        Environment.GetEnvironmentVariable("CRAZIIEMU_LOG_MOVIE_SYNC"),
        "1",
