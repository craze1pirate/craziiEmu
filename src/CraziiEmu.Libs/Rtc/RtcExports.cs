...
public static class RtcExports
{
    ...
    // caller's return address pinpoints the loop. CRAZIIEMU_RTC_PROBE_RANGE=<start>-<end>
    ...
    {
        var value = Environment.GetEnvironmentVariable("CRAZIIEMU_RTC_PROBE_RANGE");
