...
internal static class GpuWaitProfile
{
    public static readonly bool Enabled = string.Equals(
        Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_GPU_WAIT"),
        "1",
        StringComparison.Ordinal);

    private static readonly double _reportSeconds =
        double.TryParse(
            Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_GPU_WAIT_REPORT_S"),
