...
/// CRAZIIEMU_PROFILE_RENDER=1. The existing videoout counters report how much
...
internal static class RenderPhaseProfile
{
    ...
    public static readonly bool Enabled = string.Equals(
        Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_RENDER"),
        "1",
    ...
    public static readonly bool OrderedActionDetailsEnabled = string.Equals(
        Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_ORDERED_ACTION"),
        "1",
        StringComparison.Ordinal);

    private static readonly double _reportSeconds =
        double.TryParse(
            Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_RENDER_REPORT_S"),
