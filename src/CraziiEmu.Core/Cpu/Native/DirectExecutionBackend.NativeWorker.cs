...
public sealed partial class DirectExecutionBackend
{
	...
	private static readonly bool NativeGuestWorkersDisabled =
		string.Equals(Environment.GetEnvironmentVariable("CRAZIIEMU_DISABLE_NATIVE_GUEST_WORKERS"), "1", StringComparison.Ordinal);
	...
	{
		if (int.TryParse(
			    Environment.GetEnvironmentVariable("CRAZIIEMU_NATIVE_WORKER_MAX_CONCURRENT"),
			    out var parsed) &&
		    parsed > 0)
		{
