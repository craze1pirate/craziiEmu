...
public sealed partial class DirectExecutionBackend
{
	private static readonly bool _profileGuestRip =
		string.Equals(
			Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_GUEST_RIP"),
			"1",
			StringComparison.Ordinal);

	private static readonly int _profileGuestRipIntervalMs =
		int.TryParse(
			Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_GUEST_RIP_INTERVAL_MS"),
	...
	private static readonly int _profileGuestRipReportSeconds =
		int.TryParse(
			Environment.GetEnvironmentVariable("CRAZIIEMU_PROFILE_GUEST_RIP_REPORT_S"),
	...
	private void EnsureGuestRipSampler()
	{
		...
		{
			IsBackground = true,
			Name = "CraziiEmu guest RIP sampler",
