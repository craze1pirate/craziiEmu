...
public static class SysAbiExportShape
{
    ...
    public const string SysAbiExportAttributeName = "CraziiEmu.HLE.SysAbiExportAttribute";
    ...
    private const string GuestCStringAttributeName = "CraziiEmu.HLE.GuestCStringAttribute";
    ...
    private static bool IsCpuContext(ITypeSymbol type) =>
        type.ToDisplayString(SymbolDisplayFormat.FullyQualifiedFormat) == "global::CraziiEmu.HLE.CpuContext";
