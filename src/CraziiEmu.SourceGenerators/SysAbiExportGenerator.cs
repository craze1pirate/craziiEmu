...
namespace CraziiEmu.SourceGenerators;
...
public sealed class SysAbiExportGenerator : IIncrementalGenerator
{
        ...
        string assemblyName)
    {
        ...
        // (e.g. CraziiEmu.HLE itself) must not mint a colliding
        // CraziiEmu.Generated.SysAbiExportRegistry type.
        ...
        builder.AppendLine("// <auto-generated by CraziiEmu.SourceGenerators/SysAbiExportGenerator />");
        builder.AppendLine("#nullable enable");
        builder.AppendLine();
        builder.AppendLine("namespace CraziiEmu.Generated;");
        builder.AppendLine();
        ...
        builder.AppendLine("    /// </summary>");
        builder.AppendLine("    public static global::System.Collections.Generic.IReadOnlyList<global::CraziiEmu.HLE.ExportedFunction> CreateExports(");
        builder.AppendLine("        global::CraziiEmu.HLE.Generation registrationGeneration)");
        builder.AppendLine("    {");
        builder.AppendLine($"        var exports = new global::System.Collections.Generic.List<global::CraziiEmu.HLE.ExportedFunction>({exports.Length});");
        ...
        foreach (var export in exports)
        {
            ...
            builder.AppendLine(
                ...
                $"{Literal(export.ExportName)}, (global::CraziiEmu.HLE.Generation){export.Target}, {function});");
        }
        ...
        builder.AppendLine("        global::System.Collections.Generic.List<global::CraziiEmu.HLE.ExportedFunction> exports,");
        builder.AppendLine("        global::CraziiEmu.HLE.Generation registrationGeneration,");
        builder.AppendLine("        string libraryName,");
        builder.AppendLine("        string nid,");
        builder.AppendLine("        string exportName,");
        builder.AppendLine("        global::CraziiEmu.HLE.Generation attributeTarget,");
        builder.AppendLine("        global::CraziiEmu.HLE.SysAbiFunction function)");
        builder.AppendLine("    {");
        builder.AppendLine("        var target = attributeTarget == global::CraziiEmu.HLE.Generation.None ? registrationGeneration : attributeTarget;");
        builder.AppendLine("        if ((target & registrationGeneration) == 0)");
        builder.AppendLine("        {");
        builder.AppendLine("            return;");
        builder.AppendLine("        }");
        builder.AppendLine();
        builder.AppendLine("        exports.Add(new global::CraziiEmu.HLE.ExportedFunction(libraryName, nid, exportName, target, function));");
        builder.AppendLine("    }");
        builder.AppendLine("}");
    ...
    private static string TypedThunk(ExportModel export)
    {
        ...
        {
            var register = "ctx[global::CraziiEmu.HLE.CpuRegister." + SysAbiExportShape.ArgumentRegisters[index] + "]";
            if (kinds[index].StartsWith("cstring:", StringComparison.Ordinal))
            {
                ...
                reads.AppendLine("            {");
                reads.AppendLine("                return ctx.SetReturn(global::CraziiEmu.HLE.OrbisGen2Result.ORBIS_GEN2_ERROR_MEMORY_FAULT);");
                reads.AppendLine("            }");
                reads.AppendLine();
