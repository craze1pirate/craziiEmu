...
using CraziiEmu.Debugger.Protocol;
using CraziiEmu.Debugger.Session;
using CraziiEmu.Logging;

namespace CraziiEmu.Debugger.Server;
...
{
    private static readonly CraziiEmuLogger Log = CraziiEmuLog.For("CraziiEmu.Debugger");
