...
public static class GuestWriteWatch
{
    ...
    private static readonly ulong WatchBase = Parse(
        Environment.GetEnvironmentVariable("CRAZIIEMU_WATCH_WRITE"));

    private static readonly bool WatchPoolHeaders = IsEnabled("CRAZIIEMU_WATCH_POOL_HEADER");

    private static readonly ulong[] PoolSlots = new ulong[64];
    private static int _poolSlotCount;

    private static readonly bool WatchValuePattern = IsEnabled("CRAZIIEMU_WATCH_VALUE_PATTERN");

    private static readonly bool WatchValue1 = IsEnabled("CRAZIIEMU_WATCH_VALUE1");
    ...
    private static readonly bool WatchBulkTorn = IsEnabled("CRAZIIEMU_WATCH_BULK_TORN");

    private static readonly ulong BulkDestHigh = Parse(
        Environment.GetEnvironmentVariable("CRAZIIEMU_WATCH_BULK_DEST_HI"));
